					...
					<div class="col-sm-9">
						<div id="right"> 
							...
							<div class="articles">
								...
								<br /><br />
								Population growth (annual %) is the exponential rate of growth of midyear population from year t-1 to t, expressed as a percentage. Derived from total population. Population source: 
